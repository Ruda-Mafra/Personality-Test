const questions = [
  {
    questionText: "How do you prefer to spend your Saturday night?",
    options: [
      { text: "Alone", score: 1 },
  ...
  },
  {
    ...
    options: [
      { text: "I avoid them at all costs", score: 1 },
  ...
  {
    questionText: "What makes you feel most fulfilled?",
    options: [
      { text: "Having time for myself", score: 1 },
  ...
  {
    questionText: "How do you feel about social gatherings?",
    options: [
      { text: "I dislike them", score: 1 },
